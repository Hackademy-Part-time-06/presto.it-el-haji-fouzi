...
<nav class="navbar navbar-expand-lg navbar-dark bg-warning shadow mb-5  fixed-top ">
    <div class="container ">
        <a class="navbar-brand" href="{{ route('homepage') }}">
            <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/lotus.webp" alt="Aulab post"
                height="50">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
                ...
                @auth
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#"> REVISOR</a>
                    </li>
                    ...
                    <li class="nav-item list-unstyled  ">
                        <a class="dropdown-item bg-success rounded mx-2 p-2 text-center mb-0  " href="{{ route('logout') }}"
