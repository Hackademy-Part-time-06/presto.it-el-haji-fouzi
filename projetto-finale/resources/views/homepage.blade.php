                        ...
                        <div class="row">
                                ...
                                <ul class="list-unstyled mb-1">
                                    <div class="mb-1">
                                        <li><a class="btn btn-warning "
                                                href="{{ route('articles.category', $article->category) }}">Sport</a>
                                        </li>
                                    </div>
                                    <div class="mb-1">
                                        <li><a class="btn btn-warning"
                                                href="{{ route('articles.category', $article->category) }}">Food</a>
                                        </li>
                                    </div>
                                    <div>
                                        <li><a class="btn btn-warning"
                                                href="{{ route('articles.category', $article->category) }}">Economy</a>
                                        </li>
                                    </div>
                                </ul>
                            </div>
                            <div class="col-sm-6 shadow p-3 mb-5 bg-body rounded">
                                <ul class="list-unstyled mb-0">
                                    <div class="mb-1">
                                        <li><a class="btn btn-warning"
                                                href="{{ route('articles.category', $article->category->name) }}">Entertenment</a>
                                        </li>
                                    </div>
                                    <div class="mb-1">
                                        <li><a class="btn btn-warning"
                                                href="{{ route('articles.category', $article->category->name) }}">Tech</a>
                                        </li>
                                    </div>
                                    <div class="mb-1">
                                        <li><a class="btn btn-warning"
